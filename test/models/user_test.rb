...
class UserTest < ActiveSupport::TestCase
  def setup
    @user = User.new(
      ...
      organization: Organization.new(name: "test_organization"))
  end
  ...
  def test_users_should_have_unique_auth_token
    ...
    second_user = User.create!(
      ...
      password: "welcome", password_confirmation: "welcome", organization: Organization.new(name: "test organization"))
